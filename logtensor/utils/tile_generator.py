...
API Key: sk-XUovY0YBGsYqBIIbfWtFH7F4ApE0gOWUZldk5LU0JDrfLhL9
"""
...
KIMI_KEY = "sk-XUovY0YBGsYqBIIbfWtFH7F4ApE0gOWUZldk5LU0JDrfLhL9"
...
def main():
    ...
    if use_api:
        ...
        generator.save_tiles('./output/generated_tiles.json')
    else:
    ...
    with open('./output/tile_simulation_results.json', 'w') as f:
        json.dump({
